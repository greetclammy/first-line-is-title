...
var FirstLineIsTitleSettings = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(this.containerEl).setName("Rename on focus").setDesc(createFragment((fragment) => {
    ...
    new import_obsidian.Setting(this.containerEl).setName("Show notification when renaming manually").setDesc("Controls when to show notifications for the 'Put first line in title' command.").addDropdown(
    ...
    new import_obsidian.Setting(this.containerEl).setName("Character count").setDesc(createFragment((fragment) => {
    ...
    new import_obsidian.Setting(this.containerEl).setName("Check interval").setDesc(createFragment((fragment) => {
    ...
    new import_obsidian.Setting(this.containerEl).setName("Verbose logging").setDesc("Log all of the plugin's activity to the developer console.").addToggle(
      (toggle) => toggle.setValue(this.plugin.settings.verboseLogging).onChange(async (value) => {
        this.plugin.settings.verboseLogging = value;
        await this.plugin.saveSettings();
      })
    );
    new import_obsidian.Setting(this.containerEl).setName("Excluded folders").setHeading();
    const folderContainer = this.containerEl.createDiv();
    const renderExcludedFolders = () => {
      folderContainer.empty();
      this.plugin.settings.excludedFolders.forEach((folder, index) => {
        const folderSetting = new import_obsidian.Setting(folderContainer).addText((text) => {
          ...
          button.setIcon("x").setTooltip("Delete").onClick(async () => {
    ...
    new import_obsidian.Setting(this.containerEl).setName("Support for other plugins").setHeading();
    ...
    const headerToggleSetting = new import_obsidian.Setting(this.containerEl).setName("Forbidden character replacements").setClass("flit-header-setting").addToggle((toggle) => {
    ...
    updateCharacterReplacementUI();
    this.containerEl.createEl("br");
    const customHeaderToggleSetting = new import_obsidian.Setting(this.containerEl).setName("Custom replacements").setClass("flit-header-setting").addToggle((toggle) => {
    ...
    renderCustomReplacements();
    this.containerEl.createEl("br");
    const safewordsHeaderToggleSetting = new import_obsidian.Setting(this.containerEl).setName("Safewords").setClass("flit-header-setting").addToggle((toggle) => {

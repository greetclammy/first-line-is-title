...
var FirstLineIsTitleSettings = class extends import_obsidian.PluginSettingTab {
  ...
  renderExcludedFoldersTab() {
    if (!this.settingsPage) return;
    new import_obsidian.Setting(this.settingsPage).setName("Exclude subfolders").setDesc("Exclude all subfolders of excluded folders.").addToggle(

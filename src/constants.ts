...
export const DEFAULT_SETTINGS: PluginSettings = {
    core: {
        ...
        disableCursorInExcludedNotes: false,
    ...
    replaceCharacters: {
        ...
        osPreset: 'macOS',
        charReplacements: {
            slash: { replacement: ' ∕ ', enabled: false, trimLeft: false, trimRight: false },
            colon: { replacement: '։', enabled: false, trimLeft: false, trimRight: false },
            asterisk: { replacement: '∗', enabled: false, trimLeft: false, trimRight: false },
            question: { replacement: '﹖', enabled: false, trimLeft: false, trimRight: false },
            lessThan: { replacement: '‹', enabled: false, trimLeft: false, trimRight: false },
            greaterThan: { replacement: '›', enabled: false, trimLeft: false, trimRight: false },
            quote: { replacement: '＂', enabled: false, trimLeft: false, trimRight: false },
            pipe: { replacement: '❘', enabled: false, trimLeft: false, trimRight: false },
            hash: { replacement: '＃', enabled: false, trimLeft: false, trimRight: false },
            leftBracket: { replacement: '［', enabled: false, trimLeft: true, trimRight: true },
            rightBracket: { replacement: '］', enabled: false, trimLeft: true, trimRight: true },
            caret: { replacement: 'ˆ', enabled: false, trimLeft: false, trimRight: false },
            backslash: { replacement: '⧵', enabled: false, trimLeft: false, trimRight: false },
            dot: { replacement: '․', enabled: true, trimLeft: false, trimRight: false }
        }
    },
    customRules: {
